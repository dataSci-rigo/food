...
If I don't know the serving size I'll ask how many grams.
After logging, rate it 👍/👎 to save it to your COOKING.md.

*Check without logging*
  "check banana" — shows nutrition info only

*Photo*
Send a photo of a nutrition label and I'll read it.
